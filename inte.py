...
class_model = load_model('kvupdatesmodel.keras')
...
error_classes = ["cell phone", "mobile", "laptop","tablet"]
...
while True:
    ...
    if error_detected:
        cv2.putText(frame, "Warning Phone detected", (8, 500), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (255,255,255), 2)
    ...
    if hand_raised_detected and detected_hand == required_hand:
        ...
        cv2.putText(frame, f"{predicted_label.upper()} - Task Matched", (500, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (255,0, 0), 2, cv2.LINE_AA)
